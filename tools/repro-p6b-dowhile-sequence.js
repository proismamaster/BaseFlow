...
function makeApp() {
  ...
  const g=()=>({addEventListener(){},classList:{add(){},remove(){},contains(){return false;},toggle(){}},style:{},value:'',querySelector:()=>({value:''}),querySelectorAll:()=>[],appendChild(){},innerHTML:'',textContent:'',dataset:{},rows:[],setAttribute(){},removeAttribute(){},getAttribute:()=>null,hasAttribute:()=>false});
