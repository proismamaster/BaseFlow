...
run('draw(nodi);'); ins('ff.type==="normal"','while'); ins('ff.type==="loop_body"','if'); ins('ff.type==="if_true"&&ff.fromNodeIndex===2','home'); run('draw(nodi);');
...
console.log('Casa(3)->while(1) branch=null (valore reale del motore):');
console.log(' FULL:', JSON.stringify(cap(3,1,null,null)));
console.log(' OUT :', JSON.stringify(cap(3,1,null,'out')));
console.log(' BACK:', JSON.stringify(cap(3,1,null,'back')));
